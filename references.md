...
## Core References (Cited in Proposal)

### [1] Crowston, K., & Howison, J. (2005)
...
**Access:** Google BigQuery (`githubarchive` dataset)

### [15] OpenSSF Scorecard
**URL:** https://securityscorecards.dev/
**Access:** Google BigQuery (`openssf.scorecardcron`)

### [16] deps.dev (Open Source Insights)
**URL:** https://deps.dev/
**Access:** Google BigQuery (`deps-dev-insights`)

### [17] CHAOSS Project
**URL:** https://chaoss.community/
**Purpose:** Standardized metric definitions
...
### [19] GitHub (2022)
**"Sunsetting Atom"**
GitHub Blog, June 8, 2022.
**URL:** https://github.blog/news-insights/product-news/sunsetting-atom/
**Used for:** Example of popular project (tens of thousands of stars) being discontinued

### [20] He, H., Yang, H., Burckhardt, P., Kapravelos, A., Vasilescu, B., & Kästner, C. (2024)
...
- Order by first citation in text
- Include DOI for all where available

---

## Citation Mapping (GPT inline → Reference #)

| GPT Inline Citation | Verified Reference |
|---------------------|-------------------|
| `pmc.ncbi.nlm.nih.gov` | [3] Coelho & Valente 2017 |
| `kojo.blog` | Industry blog on star limitations (not academic, use for context only) |
| `arxiv.org` (fake stars) | [20] He et al. 2024 |
| `chaoss.community` | [17] CHAOSS Project + [7] Goggins et al. 2021 |
| `gharchive.org` | [14] GHArchive |
| `github.com` (Scorecard) | [15] OpenSSF Scorecard |
| `cloud.google.com` / `deps.dev` | [16] deps.dev |
| `link.springer.com` (inactive) | [4] Khondhu et al. 2013 |
| `computer.org` (bus factor) | [8] Avelino et al. 2016 |
| `researchgate.net` (Crowston) | [1] Crowston & Howison 2005 |
